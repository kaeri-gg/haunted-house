...
roof.position.y = 2.5 + 0.75 // 2.5 wall size, 0.75 half of code height size
...
for(let i = 0; i < 30; i++) {
    ...
    grave.position.x = x
    grave.position.y = Math.random() * 0.4 // height of graveGeometry
    grave.position.z = z
...
const tick = () =>
{
    ...
    // ghost
    const ghost1Angle = elapsedTime * 0.5 // to slow it down
    ghost1.position.x = Math.cos(ghost1Angle) * 4
    ghost1.position.z = Math.sin(ghost1Angle) * 4
    ghost1.position.y = -Math.sin(ghost1Angle) * Math.sin(ghost1Angle * 2.34) * Math.sin(ghost1Angle * 3.45)

    const ghost2Angle = - elapsedTime * 0.38 // to slow it down, negative to go in different direction
    ghost2.position.x = Math.cos(ghost2Angle) * 5
    ghost2.position.z = Math.sin(ghost2Angle) * 5
    ghost2.position.y = -Math.sin(ghost2Angle) * Math.sin(ghost2Angle * 2.34) * Math.sin(ghost2Angle * 3.45)

    const ghost3Angle = elapsedTime * 0.23 // to slow it down
